...
import { FiArrowRight, FiCheck, FiHome, FiMapPin } from "react-icons/fi";
...
const HeroSection = () => {
  ...
  const quickFeatures = [
    { text: 'No Hidden Fees', icon: FiCheck },
    { text: 'Easy Setup', icon: FiCheck },
    { text: '24/7 Support', icon: FiCheck }
  ];
              ...
              >
                <div>
                  ...
                  <p className="mt-4 text-lg text-white/70 max-w-2xl">
                    Effortlessly manage and list your property seamlessly all in one solution.
                  </p>
                </div>

                {/* Quick features - added back */}
