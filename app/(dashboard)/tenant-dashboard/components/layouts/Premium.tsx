      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl overflow-hidden shadow-lg transition-all duration-500">
              ...
              <div className="p-5">
                ...
                <div className="bg-white/5 rounded-lg p-5 border border-white/10 mb-6 transition-all duration-500">
                  ...
                  <div className="bg-black/30 rounded-lg p-4 mb-3">
                    ...
                    <div className="mt-3 space-y-2">
                      {[1, 2, 3].map((i) => (
                        <div 
                          key={i}
                          className="flex items-center justify-between bg-white/5 rounded-md p-2 transition-all duration-500"
                        >
                          <div className="flex items-center gap-2">
                ...
                <div className="bg-white/5 rounded-lg p-5 border border-white/10 transition-all duration-500">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                  ...
                  <div className="space-y-3">
                    <div className="bg-black/30 rounded-lg p-3 transition-all duration-500">
            ...
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl overflow-hidden shadow-lg transition-all duration-500">
              ...
              <div className="p-5">
                ...
                <div className="bg-white/5 rounded-lg p-4 border border-white/10 mb-6">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {neighborhoodData.map((item, index) => (
                      <div
                        key={index}
                        className="bg-black/30 rounded-lg p-3 text-center transition-all duration-500"
                      >
                ...
                <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                  ...
                  <div className="bg-black/30 rounded-lg p-3 mb-3 transition-all duration-500">
              ...
              <div className="px-5 py-4 border-t border-white/10 flex justify-between items-center">
                ...
                <button
                  className="bg-blue-500 hover:bg-blue-600 text-white text-xs py-1.5 px-3 rounded-md transition-transform hover:scale-105 active:scale-98 flex items-center gap-1.5 opacity-70 cursor-not-allowed"
                >
