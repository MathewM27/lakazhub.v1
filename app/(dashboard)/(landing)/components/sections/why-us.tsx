...
const FeatureCard = memo(function FeatureCard({ feature }: { feature: typeof features[0] }) {
  return (
    ...
    >
      ...
      <Link href={`#${feature.title.toLowerCase().replace(' ', '-')}`} className="group inline-flex items-center text-sm font-medium text-white transition-colors hover:text-blue-400">
        Learn more
    ...
    >
      ...
      <div className="max-w-screen-xl mx-auto px-4 md:px-8 relative z-10">
        <div className="gap-y-12 flex flex-col">
          ...
          {/* Memoized Feature cards with basic Tailwind transitions */}
